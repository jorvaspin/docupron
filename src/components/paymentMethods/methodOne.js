...
export default function methodOne() {
  const form = useRef();
  ...
  const [url, setUrl] = useState("https://sandbox.insospa.com/api/payment/methods");
 ...
 [   {
  ...
  {
      "name": "Pago Efectivo",
      "method": "pagoefectivo_payment",
      "currency": "PEN"
  },
  {
      "name": "ServiFacil",
      "method": "servifacil_payment",
      "currency": "CLP"
  },
  {
      "name": "MACH",
  ...
  {
      "name": "SafetyPay CASH",
      "method": "safetypay_payment_direct_cash",
      "currency": "CLP"
  },
  {
      "name": "Izipay",
      "method": "izipay_payment",
      "currency": "PEN"
  },
  {
      "name": "MP QR",
      "method": "mercadopagoqr_payment",
      "currency": "CLP"
  },
  {
      "name": "PayCash Peru SBX",
      "method": "paycash_payment",
      "currency": "PEN"
  },
  {
      "name": "PayCash Ecuador SBX",
      "method": "paycash_payment",
      "currency": "USD"
  },
  {
      "name": "Niubiz SBX",
      "method": "niubiz_payment",
      "currency": "PEN"
  },
  {
      "name": "Klap",
  ...
  {
      "name": "SafetyPay Express",
      "method": "safetypay_payment_express",
      "currency": "CLP"
  },
  {
      "name": "SafetyPay Direct",
      "method": "safetypay_payment_direct",
      "currency": "CLP"
  },
  {
      "name": "SafetyPay Direct PE",
      "method": "safetypay_payment_direct",
      "currency": "PEN"
  },
  {
      "name": "Fintoc",
      "method": "fintoc_payment",
      "currency": "CLP"
  },
  {
      "name": "PagoEfectivo EC",
      "method": "pagoefectivo_payment",
      "currency": "PEN"
  },
  {
  ...
  return (
    ...
    <form ref={form} onSubmit={sendRequest}>
      <div className="input-group mb-4">
        <select className="form-select flex-grow-0 w-auto" defaultValue ref={methodRef} name="method" data-method >
